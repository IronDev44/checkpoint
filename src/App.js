...
function OptionsTab({
  ...
  { id: "theme-mushroom", label: "Royaume Champignon" },
  { id: "theme-blueblur", label: "Vitesse Bleue" },
  { id: "theme-blocks", label: "Blocs Classiques" },
  { id: "theme-cubic", label: "Monde Cubique" },
  { id: "theme-hunter", label: "Chasseur Spatial" },
  { id: "theme-kart", label: "Kart Arcade" },
  { id: "theme-crystal", label: "Fantaisie Cristal" },
  { id: "theme-ring", label: "Anneau Dore" },
